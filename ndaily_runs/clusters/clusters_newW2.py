...
W, W_disp, W_reweighted, Fmap_cut = cut_trajectories_in_3W(Fmap, W_vec, w_disp, w_reweighted, distance,land_mask_reg,latitude_reg,longitude_reg, eastSval=True, canadian_greenland=True)
K = 10**7
...
clusters_path = file_path+'/k_test_clusters_K'+str(K)+'_border'+str(formatted_distance)+'_cleaned_center_spars/'
...
np.save(clusters_path+'tmin'+str(int(tmin/time_steps_per_day))+'_spar'+str(formatted_spar)+'_eigenvalues_disp.npy',l_disp)
np.save(clusters_path+'tmin'+str(int(tmin/time_steps_per_day))+'_spar'+str(formatted_spar)+'_eigenvalues.npy',l)
np.save(clusters_path+'tmin'+str(int(tmin/time_steps_per_day))+'_spar'+str(formatted_spar)+'_eigenvalues_reweighted.npy',l_reweighted)
