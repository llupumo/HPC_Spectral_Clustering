...
Fmap_path = file_path+'/'+str(int(tmin/time_steps_per_day))+'_Fmap_matrix.npy'
time_path = file_path+'/'+str(int(tmin/time_steps_per_day))+'_advection_time.npy'
W_path = file_path+'/'+str(int(tmin/time_steps_per_day))+'_W_matrix.npy'
W_reweighted_path = file_path+'/'+str(int(tmin/time_steps_per_day))+'_W_reweigthed.npy'
W_disp_path = file_path+'/'+str(int(tmin/time_steps_per_day))+'_W_disp.npy'
...
np.save(file_path+'/'+str(int(tmin/time_steps_per_day))+"_Fmap_matrix_cleaned.npy",Fmap_cleaned)
np.save(file_path+'/'+str(int(tmin/time_steps_per_day))+"_W_matrix_cleaned.npy",W_vec_cleaned)
np.save(file_path+'/'+str(int(tmin/time_steps_per_day))+"_W_disp_cleaned.npy",W_disp_cleaned)
np.save(file_path+'/'+str(int(tmin/time_steps_per_day))+"_W_reweighted_cleaned.npy",W_reweighted_cleaned)
