...
print(f"Processing year {year}, season {season}, tmin {tmin}")
...
if not os.path.exists(w_reweighted_path) or not os.path.exists(w_disp_path):  
    ...
    np.save(w_reweighted_path,w_reweighted)
    np.save(w_disp_path,w_disp)

else:
    print("The files "+w_reweighted_path+" and "+w_disp_path+" allready exists")
