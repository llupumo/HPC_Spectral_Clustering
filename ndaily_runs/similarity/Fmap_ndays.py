...
# Call the function
Fmap, DFDt, time_adv_mod = trajectory_advection(
    IC, time_data, Interpolant_u, Interpolant_v, lon_grid, lat_grid, timemod, dt, Ncores, melting=True
)
# Stop the timer
end_time = time.time()
# Calculate elapsed time
elapsed_time = end_time - start_time
print(f"Time taken to compute trajectory_advection: {elapsed_time:.4f} seconds")
