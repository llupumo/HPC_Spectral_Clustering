...
ini_final_clusters_landmask(Fmap, n_clusters, labels, results_directory+str(int(tmin/time_steps_per_day))+"_clusters"+Cluster_params+"_0.png", e, longitude, latitude, land_mask)
...
print("Plotting the clusters")
#ini_final_clusters(Fmap, n_clusters, labels, results_directory, "", e)
ini_final_clusters_landmask(Fmap, n_clusters, labels, results_directory+str(int(tmin/time_steps_per_day))+"_clusters"+Cluster_params+"_1.png", e, longitude, latitude, land_mask)
...
print("Plotting the clusters")
#ini_final_clusters(Fmap, n_clusters, labels, results_directory, "", e)
ini_final_clusters_landmask(Fmap, n_clusters, labels, results_directory+str(int(tmin/time_steps_per_day))+"_clusters"+Cluster_params+"_2.png", e, longitude, latitude, land_mask)